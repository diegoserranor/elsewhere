...
// gpui has no built-in text input; this implements EntityInputHandler (IME
// support) plus a custom Element that shapes and paints the line.
...
// Call once at app startup; without this the input receives no keys.
